...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	function foundationpress_scripts() {
        ...
        // overrides and 2020 patches - inheriting the site and only small changes required, best to add a separate style sheet
        // this point rather than try to debug legacy code with newer build tools
        wp_enqueue_style( 'updates-2020', get_stylesheet_directory_uri() . '/assets/stylesheets/updates-2020.css' );
        ...
        wp_enqueue_script( 'jquery-migrate', '//code.jquery.com/jquery-migrate-1.4.1.min.js' );

        wp_enqueue_script( 'updates-2020', get_template_directory_uri() . '/assets/javascript/updates-2020.js');
