...
<link rel='stylesheet prefetch' href='<?php bloginfo('template_url');?>/assets/stylesheets/full-page-scroll.css'>
...
<div id="fullpage" class="scroll-container">
    ...
    <a href="#secondSection" class="icon-down_arrow">
    ...
    <a href="#thirdSection" class="icon-down_arrow">
      <img src="<?php bloginfo('template_url');?>/assets/images/slide_down_arrow.png" alt="icon" />
    </a>
	</section>
    ...
    <a href="#forthSection" class="icon-down_arrow">
      <img src="<?php bloginfo('template_url');?>/assets/images/slide_down_arrow.png" alt="icon" />
    </a>
	</section>
...
<script src='<?php bloginfo( 'template_url' );?>/assets/javascript/custom/full-page-scroll.js'></script>
<script src='<?php bloginfo( 'template_url' );?>/assets/javascript/custom/rt-full-page-scroll.js'></script>
<?php endwhile;?>
