	...
	?>
		...
		<script type="text/javascript">
			...
			jQuery(document).on('ready', function(){
                ...
                /*  close video button is hidden as it was overlapping with
                    YouTube's embedded controls. the back button is the only
                    way to get out of the video early - before it plays through
